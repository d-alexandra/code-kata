...
Then print it in the format dd.mm.yyyy, where dd is the two-digit day, mm is the two-digit month, and yyyy is year.
For example, the given year = 1984 is divisible by 4, so it is a leap year. The 256th day of a leap year after 1918 is September 12, so the answer is 12.09.1984. */

function isLeap (year) {
  if (year % 4 > 0) return false
  if (year > 1918 && year % 100 > 0) return true
  if (year > 1918 && year % 400 === 0) return true
  if (year < 1918 && year % 4 === 0) return true
  else return false
}

function dayOfProgrammer (year) {
  if (year === 1918) return '26.09.' + year
  else if (year >= 1700 & year <= 2700) {
